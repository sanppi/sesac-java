...
//      int 2name; // 숫자 첫 글자 사용 불가
        int student_ID$; // 특수 기호는 '_', '$' 만 가능
        int name2; // 숫자 첫 글자 제외는 가능
...
//        Primitive Type (기본형)
        ...
        // 정수형 변수 선언
        int x = 10;
        long y = 10000000L; // long 타입은 뒤에 'L' 또는 'l'을 붙여야 한다.
        short z = 32767;
        byte b = 127;
...
class Person {
    ...
    // 호출되는 메서드, name 이랑 age 변수 두 개를 받아서, Person 클래스로  name, age 값을 갖는,,
